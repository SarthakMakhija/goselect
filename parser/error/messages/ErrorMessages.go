...
const (
	...
	ErrorMessageInvalidProjection                   = "invalid projection list, please check opening and closing parentheses for all the functions"
	...
	ErrorMessageInvalidWhereFunctionUsed            = "invalid where clause, 'where' supports only functions. please use either of %v"
