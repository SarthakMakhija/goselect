...
const (
	...
	ErrorMessageInvalidWhereFunctionUsed                  = "invalid where clause, 'where' clause must be a single expression. please check all the function supported in 'where' clause"
